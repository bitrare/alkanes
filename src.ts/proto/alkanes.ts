...
export namespace alkanes {
    ...
    export class HoldersByTokenRequest extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            token_id?: AlkaneId;
        }) {
        ...
        static fromObject(data: {
            token_id?: ReturnType<typeof AlkaneId.prototype.toObject>;
        }): HoldersByTokenRequest {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): HoldersByTokenRequest {
        ...
        static deserializeBinary(bytes: Uint8Array): HoldersByTokenRequest {
            return HoldersByTokenRequest.deserialize(bytes);
        }
    }
    export class HolderOutpoint extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            txid?: Uint8Array;
            vout?: number;
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): HolderOutpoint {
        ...
        static deserializeBinary(bytes: Uint8Array): HolderOutpoint {
            return HolderOutpoint.deserialize(bytes);
        }
    }
    export class TokenHolder extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            address?: string;
            total_balance?: uint128;
            outpoints?: HolderOutpoint[];
        }) {
            super();
        ...
        set total_balance(value: uint128) {
            pb_1.Message.setWrapperField(this, 2, value);
        }
        ...
        get outpoints() {
            return pb_1.Message.getRepeatedWrapperField(this, HolderOutpoint, 3) as HolderOutpoint[];
        }
        set outpoints(value: HolderOutpoint[]) {
            pb_1.Message.setRepeatedWrapperField(this, 3, value);
        }
        static fromObject(data: {
            address?: string;
            total_balance?: ReturnType<typeof uint128.prototype.toObject>;
            outpoints?: ReturnType<typeof HolderOutpoint.prototype.toObject>[];
        }): TokenHolder {
        ...
        toObject() {
            ...
            if (this.outpoints != null) {
                data.outpoints = this.outpoints.map((item: HolderOutpoint) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.outpoints.length)
                writer.writeRepeatedMessage(3, this.outpoints, (item: HolderOutpoint) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): TokenHolder {
        ...
        static deserializeBinary(bytes: Uint8Array): TokenHolder {
            return TokenHolder.deserialize(bytes);
        }
    }
    export class HoldersByTokenResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            holders?: TokenHolder[];
        }) {
        ...
        get holders() {
            return pb_1.Message.getRepeatedWrapperField(this, TokenHolder, 1) as TokenHolder[];
        }
        set holders(value: TokenHolder[]) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        static fromObject(data: {
            holders?: ReturnType<typeof TokenHolder.prototype.toObject>[];
        }): HoldersByTokenResponse {
        ...
        toObject() {
            ...
            if (this.holders != null) {
                data.holders = this.holders.map((item: TokenHolder) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.holders.length)
                writer.writeRepeatedMessage(1, this.holders, (item: TokenHolder) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): HoldersByTokenResponse {
        ...
        static deserializeBinary(bytes: Uint8Array): HoldersByTokenResponse {
