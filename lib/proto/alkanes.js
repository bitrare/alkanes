...
(function (alkanes) {
    ...
    class HoldersByTokenRequest extends pb_1.Message {
        constructor(data) {
            super();
            _HoldersByTokenRequest_one_of_decls.set(this, []);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _HoldersByTokenRequest_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        static fromObject(data) {
            const message = new HoldersByTokenRequest({});
            if (data.token_id != null) {
                message.token_id = AlkaneId.fromObject(data.token_id);
            }
            return message;
        }
        toObject() {
            ...
            if (this.token_id != null) {
                data.token_id = this.token_id.toObject();
            }
            return data;
        }
        serialize(w) {
            const writer = w || new pb_1.BinaryWriter();
            if (this.has_token_id)
                writer.writeMessage(1, this.token_id, () => this.token_id.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes) {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new HoldersByTokenRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.token_id, () => message.token_id = AlkaneId.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
        ...
        static deserializeBinary(bytes) {
            return HoldersByTokenRequest.deserialize(bytes);
        }
    }
    _HoldersByTokenRequest_one_of_decls = new WeakMap();
    alkanes.HoldersByTokenRequest = HoldersByTokenRequest;
    class HolderOutpoint extends pb_1.Message {
        constructor(data) {
            super();
            _HolderOutpoint_one_of_decls.set(this, []);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _HolderOutpoint_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
                if ("txid" in data && data.txid != undefined) {
                    this.txid = data.txid;
                }
        ...
        static fromObject(data) {
            const message = new HolderOutpoint({});
            if (data.txid != null) {
                message.txid = data.txid;
            }
            if (data.vout != null) {
        ...
        serialize(w) {
            ...
            if (this.vout != 0)
                writer.writeUint32(2, this.vout);
            if (this.has_balance)
                writer.writeMessage(3, this.balance, () => this.balance.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes) {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new HolderOutpoint();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes) {
            return HolderOutpoint.deserialize(bytes);
        }
    }
    _HolderOutpoint_one_of_decls = new WeakMap();
    alkanes.HolderOutpoint = HolderOutpoint;
    class TokenHolder extends pb_1.Message {
        constructor(data) {
            super();
            _TokenHolder_one_of_decls.set(this, []);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [3], __classPrivateFieldGet(this, _TokenHolder_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get has_total_balance() {
            return pb_1.Message.getField(this, 2) != null;
        }
        get outpoints() {
            return pb_1.Message.getRepeatedWrapperField(this, HolderOutpoint, 3);
        }
        set outpoints(value) {
            pb_1.Message.setRepeatedWrapperField(this, 3, value);
        }
        static fromObject(data) {
            const message = new TokenHolder({});
            if (data.address != null) {
                message.address = data.address;
            }
            if (data.total_balance != null) {
                message.total_balance = uint128.fromObject(data.total_balance);
            }
            if (data.outpoints != null) {
                message.outpoints = data.outpoints.map(item => HolderOutpoint.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.total_balance != null) {
                data.total_balance = this.total_balance.toObject();
            }
        ...
        serialize(w) {
            ...
            if (this.has_total_balance)
                writer.writeMessage(2, this.total_balance, () => this.total_balance.serialize(writer));
            if (this.outpoints.length)
                writer.writeRepeatedMessage(3, this.outpoints, (item) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes) {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new TokenHolder();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.total_balance, () => message.total_balance = uint128.deserialize(reader));
                        break;
                    case 3:
                        reader.readMessage(message.outpoints, () => pb_1.Message.addToRepeatedWrapperField(message, 3, HolderOutpoint.deserialize(reader), HolderOutpoint));
                        break;
                    default: reader.skipField();
                }
            }
        ...
        static deserializeBinary(bytes) {
            return TokenHolder.deserialize(bytes);
        }
    }
    _TokenHolder_one_of_decls = new WeakMap();
    alkanes.TokenHolder = TokenHolder;
    class HoldersByTokenResponse extends pb_1.Message {
        constructor(data) {
            super();
            _HoldersByTokenResponse_one_of_decls.set(this, []);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _HoldersByTokenResponse_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get holders() {
            return pb_1.Message.getRepeatedWrapperField(this, TokenHolder, 1);
        }
        set holders(value) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        static fromObject(data) {
            const message = new HoldersByTokenResponse({});
            if (data.holders != null) {
                message.holders = data.holders.map(item => TokenHolder.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.holders != null) {
                data.holders = this.holders.map((item) => item.toObject());
            }
            return data;
        }
        serialize(w) {
            ...
            if (this.holders.length)
                writer.writeRepeatedMessage(1, this.holders, (item) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes) {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new HoldersByTokenResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.holders, () => pb_1.Message.addToRepeatedWrapperField(message, 1, TokenHolder.deserialize(reader), TokenHolder));
                        break;
                    default: reader.skipField();
                }
            }
        ...
        static deserializeBinary(bytes) {
            return HoldersByTokenResponse.deserialize(bytes);
        }
    }
    _HoldersByTokenResponse_one_of_decls = new WeakMap();
    alkanes.HoldersByTokenResponse = HoldersByTokenResponse;
