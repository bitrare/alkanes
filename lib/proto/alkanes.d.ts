...
export declare namespace alkanes {
    ...
    class HoldersByTokenRequest extends pb_1.Message {
        ...
        get token_id(): AlkaneId;
        set token_id(value: AlkaneId);
        get has_token_id(): boolean;
        static fromObject(data: {
    ...
    class TokenHolder extends pb_1.Message {
        ...
        get total_balance(): uint128;
        set total_balance(value: uint128);
        get has_total_balance(): boolean;
        get outpoints(): HolderOutpoint[];
